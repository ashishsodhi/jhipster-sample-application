...
@RestController
@RequestMapping("/api/jhipster-sample-applicationmicroservice-kafka")
public class JhipsterSampleApplicationmicroserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationmicroserviceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplicationmicroserviceKafkaResource(KafkaProperties kafkaProperties) {
