...
class JhipsterSampleApplicationmicroserviceKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationmicroserviceKafkaResource kafkaResource = new JhipsterSampleApplicationmicroserviceKafkaResource(
            kafkaProperties
        );
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-applicationmicroservice-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-applicationmicroservice-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
